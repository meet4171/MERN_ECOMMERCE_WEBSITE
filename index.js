...
server.post("/create-checkout-session", async (req, res) => {
    ...
    const session = await stripe.checkout.sessions.create({
        ...
        mode: 'payment',
        success_url: `https://mern-ecommerce-website-one.vercel.app/order-success/${orderDetails.id}`,
        cancel_url: `https://mern-ecommerce-website-one.vercel.app/order-cancalled/`,
    });
